...
--
-- Name: data_info; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.data_info (
    ...
    id_facteur bigint,
    id_utilisateur character varying(255),
    quantity double precision,
    entreprise_id bigint NOT NULL
);


ALTER TABLE public.data_info OWNER TO admin;

--
-- Name: data_info_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.data_info ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.data_info_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.entreprise (
    ...
    nom character varying(255) NOT NULL,
    type character varying(255),
    CONSTRAINT entreprise_type_check CHECK (((type)::text = ANY ((ARRAY['TECHNOLOGIE'::character varying, 'SANTE'::character varying, 'FINANCE'::character varying, 'EDUCATION'::character varying, 'AUTRE'::character varying])::text[])))
);
...
--
-- Name: type_facteurs; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.type_facteurs (
    type_id bigint NOT NULL,
    facteurs_id bigint NOT NULL
);


ALTER TABLE public.type_facteurs OWNER TO admin;
...
3905cfad-7099-45cc-a96d-685320385613	0b84e58a-40f9-4c28-8277-fec564415174
3905cfad-7099-45cc-a96d-685320385613	7c9ad2b9-d89b-4ff6-b625-3637de83d666
3905cfad-7099-45cc-a96d-685320385613	0d833f8d-98cb-42be-9a07-4c1a0adf287b
0d833f8d-98cb-42be-9a07-4c1a0adf287b	7c9ad2b9-d89b-4ff6-b625-3637de83d666
0d833f8d-98cb-42be-9a07-4c1a0adf287b	0b84e58a-40f9-4c28-8277-fec564415174
0d833f8d-98cb-42be-9a07-4c1a0adf287b	44f5ac06-3d80-4179-92eb-135e44936344
0d833f8d-98cb-42be-9a07-4c1a0adf287b	92ed1938-ab02-4436-ac42-8487ccdab8ea
0d833f8d-98cb-42be-9a07-4c1a0adf287b	3f807fd7-6174-44cf-b199-359f6232320e
0d833f8d-98cb-42be-9a07-4c1a0adf287b	63eff15a-18b1-40bb-bbb6-e0f2a4ae7452
...
0d833f8d-98cb-42be-9a07-4c1a0adf287b	3ee68063-6fea-4e3f-8d0e-93752e91030f
...
a5e7de42-6269-411a-988f-e1e64bad35b6	\N	password	ca100557-67f7-4c2b-a83c-f78351aaca77	1724336852075	\N	{"value":"b63oar45dVUvCmCumQDHz8o0+TjYnq0mnoPhovws0Ug=","salt":"i7yNtYftSzjT00qo+FnqSQ==","additionalParameters":{}}	{"hashIterations":5,"algorithm":"argon2","additionalParameters":{"hashLength":["32"],"memory":["7168"],"type":["id"],"version":["1.3"],"parallelism":["1"]}}	10
2ad50673-6bd1-4073-b203-bb9d88f30d6e	\N	password	b73d6497-050f-4af3-99b0-044a39466330	1724338036727	\N	{"value":"qxsBu3HuhRbcmJNYQTMnmVJOn1rl1wumVKcj69LXdO4=","salt":"+BRNtVkw+xwsEOzzBxy/lA==","additionalParameters":{}}	{"hashIterations":5,"algorithm":"argon2","additionalParameters":{"hashLength":["32"],"memory":["7168"],"type":["id"],"version":["1.3"],"parallelism":["1"]}}	10
\.


--
-- Data for Name: data_info; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.data_info (id, date, emission, id_facteur, id_utilisateur, quantity, entreprise_id) FROM stdin;
\.
...
COPY public.demande_utilisateur (id, email, nom, nom_utilisateur, password, prenom, role, send_date, entreprise_id) FROM stdin;
\.
...
COPY public.entreprise (id, update_date, created_date, is_deleted, adresse, bloque, nom, type) FROM stdin;
\.
...
COPY public.facteur (id, update_date, created_date, is_deleted, active, emission_factor, nom, unit, entreprise_id, type_id) FROM stdin;
\.
...
COPY public.type (id, update_date, created_date, is_deleted, active, name, entreprise_id, parent_id) FROM stdin;
\.


--
-- Data for Name: type_facteurs; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.type_facteurs (type_id, facteurs_id) FROM stdin;
\.
...
ca100557-67f7-4c2b-a83c-f78351aaca77	manager@email.com	manager@email.com	f	t	\N	manager	manager	3f237d26-0988-482a-b1c2-14ce1e4b950f	manager	1724336852029	\N	0
b73d6497-050f-4af3-99b0-044a39466330	responsable@email.com	responsable@email.com	f	t	\N	responsable	responsable	3f237d26-0988-482a-b1c2-14ce1e4b950f	responsable	1724338036686	\N	0
\.
...
3c4e2f83-7e42-4a2f-9c34-21cdfb854a70	ca100557-67f7-4c2b-a83c-f78351aaca77
0d833f8d-98cb-42be-9a07-4c1a0adf287b	ca100557-67f7-4c2b-a83c-f78351aaca77
3c4e2f83-7e42-4a2f-9c34-21cdfb854a70	b73d6497-050f-4af3-99b0-044a39466330
0b84e58a-40f9-4c28-8277-fec564415174	b73d6497-050f-4af3-99b0-044a39466330
...
--
-- Name: data_info_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.data_info_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.demande_utilisateur_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.entreprise_id_seq', 1, false);
...
--
-- Name: data_info data_info_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.data_info
    ADD CONSTRAINT data_info_pkey PRIMARY KEY (id);
...
--
-- Name: data_info ukfh3f6t53nmewysn61bkptjq4q; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.data_info
    ADD CONSTRAINT ukfh3f6t53nmewysn61bkptjq4q UNIQUE (date, id_utilisateur, id_facteur);


--
-- Name: type_facteurs ukgxg9dy5y8cvobdfo7uoo6aui0; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.type_facteurs
    ADD CONSTRAINT ukgxg9dy5y8cvobdfo7uoo6aui0 UNIQUE (facteurs_id);
...
--
-- Name: type_facteurs fk5n7hynmqejpixqejsunmoqiqx; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.type_facteurs
    ADD CONSTRAINT fk5n7hynmqejpixqejsunmoqiqx FOREIGN KEY (facteurs_id) REFERENCES public.facteur(id);


--
-- Name: facteur fk6g6nyuxgvqoq4biqy4y2vtwcp; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.facteur
    ADD CONSTRAINT fk6g6nyuxgvqoq4biqy4y2vtwcp FOREIGN KEY (entreprise_id) REFERENCES public.entreprise(id);
...
--
-- Name: data_info fkbtbbvpsbhe8210jn2xs5vnvuu; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.data_info
    ADD CONSTRAINT fkbtbbvpsbhe8210jn2xs5vnvuu FOREIGN KEY (entreprise_id) REFERENCES public.entreprise(id);
...
--
-- Name: type fkg526ljy9lneye2mf1qsis6ynw; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.type
    ADD CONSTRAINT fkg526ljy9lneye2mf1qsis6ynw FOREIGN KEY (entreprise_id) REFERENCES public.entreprise(id);


--
-- Name: type_facteurs fksitrcmkl7bgkc4qn9gids8qyq; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.type_facteurs
    ADD CONSTRAINT fksitrcmkl7bgkc4qn9gids8qyq FOREIGN KEY (type_id) REFERENCES public.type(id);
