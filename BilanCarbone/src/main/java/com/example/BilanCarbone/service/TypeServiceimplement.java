...
public class TypeServiceimplement implements TypeService {
    ...
    public PageResponse<TypeResponse> list_all_detail(int page, int size, String search, String... order) {
        ...
        PageResponse<TypeResponse> pageResponse = new PageResponse<>();
        pageResponse.setContent(list);
        pageResponse.setNumber(respage.getNumber());
        pageResponse.setSize(respage.getSize());
        pageResponse.setTotalElements(respage.getTotalElements());
        pageResponse.setTotalPages(respage.getTotalPages());
        pageResponse.setFirst(respage.isFirst());
        pageResponse.setLast(respage.isLast());
